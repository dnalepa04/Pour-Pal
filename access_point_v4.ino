...
const int inPins[12] = {
  ...
  7, 8,  // IN5, IN6  -> Pump 3
  9, 10,  // IN7, IN8  -> Pump 4
  A0, A1,  // IN9, IN10 -> Pump 5 lower flow
  A2, A3    // IN11, IN12-> Pump 6 lower flow
};
...
// Function to stop pumps immediately
...
void setup() {
  ...
  server.on("/cleanse", handleCleanse); // NEW
  server.begin();
...
<button type="button" onclick="cleanseTubing()">Cleanse Tubing</button>
</form>
</section>
...
// Cleanse all tubing by running pumps in reverse for 5 seconds
void handleCleanse() {
